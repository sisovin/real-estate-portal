        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="mb-5">
                    ...
                    <p>Welcome to our Real Estate Venue Portal, your premier destination for discovering and booking exceptional venues. Whether you're planning a wedding, corporate event, or special gathering, we connect you with top-tier locations tailored to your needs.</p>
                </div>
        ...
        <div class="row pt-5 mt-5 text-center">
            <div class="col-md-12">
                <p>
                    ...
                    Copyright &copy;</script><script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://peanech.online" target="_blank" >Peanech Team</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
